...
python -m models.generate_scenegraph -m predcls -model motifnet -order leftright -nl_obj 2 -nl_edge 4 -b 1 -clip 5 \
    -p 100 -hidden_dim 512 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -test -ckpt /scratch/cluster/ankgarg/gqa/temp_abhinav/checkpoints/temp/vgrel-0.tar -nepoch 50 -use_bias -cache motifnet_generate_scenegraph